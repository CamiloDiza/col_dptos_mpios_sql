...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-10-2020 a las 16:37:19
...
--
-- Base de datos: `dptos_mpios_colombia`
--
...
CREATE TABLE `municipios` (
  ...
  `municipio` varchar(64) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `municipios` (`id_municipio`, `municipio`, `departamentos_id_departamento`) VALUES
(5001, 'MEDELLÍN', 5),
(5002, 'ABEJORRAL', 5),
(5004, 'ABRIAQUÍ', 5),
(5021, 'ALEJANDRÍA', 5),
...
ALTER TABLE `municipios`
  ...
  ADD UNIQUE KEY `id_municipio_UNIQUE` (`id_municipio`),
...
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `fk_municipios_departamentos` FOREIGN KEY (`departamentos_id_departamento`) REFERENCES `departamentos` (`id_departamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
